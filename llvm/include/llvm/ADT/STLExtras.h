...
inline void sort(IteratorTy Start, IteratorTy End) {
  using ST = typename std::iterator_traits<IteratorTy>::value_type;
  fluxsort<ST>(&(*Start), std::distance(Start, End), sizeof(ST), std::less<ST>());
}
...
inline void sort(IteratorTy Start, IteratorTy End, Compare Comp) {
  using ST = typename std::iterator_traits<IteratorTy>::value_type;
  fluxsort<ST>(&(*Start), std::distance(Start, End), sizeof(ST), Comp);
}
